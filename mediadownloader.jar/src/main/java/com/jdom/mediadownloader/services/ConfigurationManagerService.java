...
public interface ConfigurationManagerService {
    ...
    /**
     * Retrieve the implementation class to find available links for a series.
     * 
     * @return the link finder implementation
     */
    SeriesLinkFinder getSeriesLinkFinder();

    /**
     * Returns the last modified time of a file in minutes for it to be able to be picked up.
     * 
    ...
    /**
     * Returns the time to allow a series download attempt to live in the queue, in hours.
     * 
