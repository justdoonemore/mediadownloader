...
public class NzbRetrieveActionTest {
	...
	private NzbRetrieveAction action;
	...
	public void setUp() throws IOException {
		action = new NzbRetrieveAction();

		workingDir = TestUtil.setupTestClassDir(NzbRetrieveActionTest.class);
	...
	public void testUnpackPrefixFoldersArentMovedEvenIfPastTime()
		...
		File unpackPrefixFolder = createFolderWithFile(downloadedDirectory,
				NzbRetrieveAction.UNPACK_PREFIX + "_SHOULD_NOT_MOVE");
