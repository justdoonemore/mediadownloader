...
import com.jdom.mediadownloader.domain.AbstractEntityTest;
...
public final class SeriesNotificationTest extends
	...
	private static final User USER = new User("SomeGuy", "random@random.com");
	...
	public void testCompareToReturnsUserResultsWhenSeriesAreSame() {
		User anotherUser = new User("anotherUser", "blah@blah.com");
		SeriesNotification cloned = SERIES_NOTIFICATION.clone();
